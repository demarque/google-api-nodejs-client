...
import { GoogleConfigurable, createAPIRequest, MethodOptions, GlobalOptions, BodyResponseCallback } from 'googleapis-common';
...
export interface Schema$ListTransactionsResponse {
      /**
     * Token that needs to be passed in the next request to get the next set of transactions. Empty when there are no more transactions to fetch.
     */
        nextPageToken?: string;
        /**
     * Result transactions, size of which will be less than or equal to the given page_size in the request.
     */
...
export interface Schema$Transaction {
     ...
     */
        ...
        /**
     * Currency conversion rate used when the purchase currency and payment currency are different.
     */
     ...
     */
        ...
        /**
     * Number of copies involved in this transaction. Negative value when transactionType is refund.
     */
        quantity?: number;
        /**
 ...
 */
list(params?: Params$Resource$Partners$List, options?: MethodOptions): AxiosPromise<Schema$ListPartnersResponse>;
...
list(paramsOrCallback?: Params$Resource$Partners$List|BodyResponseCallback<Schema$ListPartnersResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ListPartnersResponse>, callback?: BodyResponseCallback<Schema$ListPartnersResponse>): void|AxiosPromise<Schema$ListPartnersResponse> {
  ...
  const parameters = {
    options: Object.assign({
      url: (rootUrl + '/bookspartner/v1/partners').replace(/([^:]\/)\/+/g, '$1'),
      method: 'GET'
    }, options),
    params,
        requiredParams: [],
 ...
 * @return {object} Request object
 */
list(params?: Params$Resource$Partners$Paymentprofiles$List, options?: MethodOptions): AxiosPromise<Schema$ListPaymentProfilesResponse>;
list(params: Params$Resource$Partners$Paymentprofiles$List, options: MethodOptions|BodyResponseCallback<Schema$ListPaymentProfilesResponse>, callback: BodyResponseCallback<Schema$ListPaymentProfilesResponse>): void;
list(params: Params$Resource$Partners$Paymentprofiles$List, callback: BodyResponseCallback<Schema$ListPaymentProfilesResponse>): void;
list(callback: BodyResponseCallback<Schema$ListPaymentProfilesResponse>): void;
list(paramsOrCallback?: Params$Resource$Partners$Paymentprofiles$List|BodyResponseCallback<Schema$ListPaymentProfilesResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ListPaymentProfilesResponse>, callback?: BodyResponseCallback<Schema$ListPaymentProfilesResponse>): void|AxiosPromise<Schema$ListPaymentProfilesResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Partners$Paymentprofiles$List;
  let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  const parameters = {
    options: Object.assign({
      url: (rootUrl + '/bookspartner/v1/partners/{partnerId}/paymentprofiles').replace(/([^:]\/)\/+/g, '$1'),
      method: 'GET'
    }, options),
    params,
    ...
    if (callback) {
    createAPIRequest<Schema$ListPaymentProfilesResponse>(parameters, callback);
  } else {
    return createAPIRequest<Schema$ListPaymentProfilesResponse>(parameters);
      ...
      root: Bookspartner;
        ...
        this.root = root;
        this.getRoot.bind(this);
                                          this.transactions = new Resource$Partners$Paymentprofiles$Invoices$Transactions(root);
                        }
 ...
 * @return {object} Request object
 */
list(params?: Params$Resource$Partners$Paymentprofiles$Invoices$List, options?: MethodOptions): AxiosPromise<Schema$ListInvoicesResponse>;
list(params: Params$Resource$Partners$Paymentprofiles$Invoices$List, options: MethodOptions|BodyResponseCallback<Schema$ListInvoicesResponse>, callback: BodyResponseCallback<Schema$ListInvoicesResponse>): void;
list(params: Params$Resource$Partners$Paymentprofiles$Invoices$List, callback: BodyResponseCallback<Schema$ListInvoicesResponse>): void;
list(callback: BodyResponseCallback<Schema$ListInvoicesResponse>): void;
list(paramsOrCallback?: Params$Resource$Partners$Paymentprofiles$Invoices$List|BodyResponseCallback<Schema$ListInvoicesResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ListInvoicesResponse>, callback?: BodyResponseCallback<Schema$ListInvoicesResponse>): void|AxiosPromise<Schema$ListInvoicesResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Partners$Paymentprofiles$Invoices$List;
  let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  const parameters = {
    options: Object.assign({
      url: (rootUrl + '/bookspartner/v1/partners/{partnerId}/paymentprofiles/{paymentProfileId}/invoices').replace(/([^:]\/)\/+/g, '$1'),
      method: 'GET'
    }, options),
    params,
 ...
 * @return {object} Request object
 */
list(params?: Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List, options?: MethodOptions): AxiosPromise<Schema$ListTransactionsResponse>;
list(params: Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List, options: MethodOptions|BodyResponseCallback<Schema$ListTransactionsResponse>, callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(params: Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List, callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(paramsOrCallback?: Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List|BodyResponseCallback<Schema$ListTransactionsResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ListTransactionsResponse>, callback?: BodyResponseCallback<Schema$ListTransactionsResponse>): void|AxiosPromise<Schema$ListTransactionsResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List;
  let options = (optionsOrCallback || {}) as MethodOptions;

  if (typeof paramsOrCallback === 'function') {
    callback = paramsOrCallback;
    params = {} as Params$Resource$Partners$Paymentprofiles$Invoices$Transactions$List;
    options = {};
  }
  ...
  const parameters = {
    options: Object.assign({
      url: (rootUrl + '/bookspartner/v1/partners/{partnerId}/paymentprofiles/{paymentProfileId}/invoices/{invoiceId}/transactions').replace(/([^:]\/)\/+/g, '$1'),
      method: 'GET'
    }, options),
    params,
 ...
 * @desc Returns the list of transactions for the given regions and time period.
 ...
 * @return {object} Request object
 */
list(params?: Params$Resource$Partners$Transactions$List, options?: MethodOptions): AxiosPromise<Schema$ListTransactionsResponse>;
list(params: Params$Resource$Partners$Transactions$List, options: MethodOptions|BodyResponseCallback<Schema$ListTransactionsResponse>, callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(params: Params$Resource$Partners$Transactions$List, callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(callback: BodyResponseCallback<Schema$ListTransactionsResponse>): void;
list(paramsOrCallback?: Params$Resource$Partners$Transactions$List|BodyResponseCallback<Schema$ListTransactionsResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ListTransactionsResponse>, callback?: BodyResponseCallback<Schema$ListTransactionsResponse>): void|AxiosPromise<Schema$ListTransactionsResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Partners$Transactions$List;
  let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  const parameters = {
    options: Object.assign({
      url: (rootUrl + '/bookspartner/v1/partners/{partnerId}/transactions').replace(/([^:]\/)\/+/g, '$1'),
      method: 'GET'
    }, options),
    params,
        requiredParams: ['partnerId'],
    ...
    return createAPIRequest<Schema$ListTransactionsResponse>(parameters);
          ...
          auth?: string|OAuth2Client|JWT|Compute|UserRefreshClient;
              ...
              pageSize?: number;
                          /**
               * Page token for this request. In a paginated request, this should be copied from next_page_token in the previous ListTransactionsResponse.
               */
              pageToken?: string;
                          /**
